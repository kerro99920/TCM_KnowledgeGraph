"""
Convert medicine_extraction.json to Alpaca format and save as medicine_alpaca.json.
Input comes from original text in crawler/medicine_details, output is extracted JSON string.
"""
...
RESULT_JSON = "extraction/medicine_extraction.json"
FOLDER = "crawler/medicine_details"
OUTPUT_JSON = "extraction/medicine_alpaca.json"
